...

{
  ...
  programs = {
    ...
    zsh = {
      ...
      shellAliases = {
        ll = "ls -l";
        upgrade = "sudo nix flake update --flake '/etc/nixos?submodules=1#default' && sudo nixos-rebuild switch --flake '/etc/nixos?submodules=1#default' --upgrade --upgrade-all -v";
